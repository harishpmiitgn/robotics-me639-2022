...
deg = deg%360
scale_fact = 0.1
fv = float(input("Enter normal force :"))
f = fv*scale_fact
...
if deg <= 180:
    ...
    degf = deg- wx/np.absolute(wx) * 90
#For Torque analysis
# fox,foy = fv*cos(degf*3.14/180),fv*sin(degf*3.14/180)
# to1,to2 = -l1*sin(theta1)*fox+l1*cos(theta1)*foy,-l2*sin(theta2)*fox+l2*cos(theta1)*foy
