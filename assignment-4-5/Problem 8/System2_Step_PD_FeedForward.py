...
for i in np.arange(1, N) :
	...
	tau  = disturb_tau[i]
	tau += Controller.openLoopControlSystem2(desired_state)
	tau += Controller.PDControlSystem2(desired_state, state)

	solution = solve_ivp(System.system2StateDerivative, [t[i-1], t[i]], state, args=(tau,))
